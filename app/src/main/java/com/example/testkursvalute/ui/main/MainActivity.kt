package com.example.testkursvalute.ui.main
...
import com.example.testkursvalute.navigation.NavigationHost
...
class MainActivity : AppCompatActivity(), NavigationHost {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navController?.apply { mainBottomNavigationView.setupWithNavController(this) }
    }

    override fun registerToolbarWithNavigation(toolbar: Toolbar) {
        navController?.apply { toolbar.setupWithNavController(this, appBarConfiguration) }
    }
